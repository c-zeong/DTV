...
#[tauri::command]
pub async fn fetch_douyu_room_info(room_id: String) -> Result<serde_json::Value, String> { // Renamed to avoid conflict if a generic fetch_room_info is added later
